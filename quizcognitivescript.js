...
function setNextQuestion(){
    resetState()
    showQuestion(cognitiveQuestions[currentIndex])
}
...
function selectAnswer(e) {
    ...
    if (cognitiveQuestions.length > currentIndex) {
        setNextQuestion()
    }
    else {
        resetState()
...
function displayTech() {
    if (techList.includes("noRecCardNID") && techList.includes("noRecCardVID") && techList.includes("noRecCardTID")) {
...
const cognitiveQuestions = [
    {  
        question: 'Do you have difficulty understanding speech?',
        answers: [
            {text: 'Yes', nxtQuestion:1, tech:["1", "2", "3"]},
            {text: 'No', nxtQuestion:1, tech:["noRecCardNID"]}
        ]
    },
    {  
        question: 'Do you have difficulty reading and understanding content?',
        answers: [
            {text: 'Yes', nxtQuestion:2, tech:["4", "5", "6"]},
            {text: 'No', nxtQuestion:2, tech:["noRecCardVID"]}
        ]
    },
    {  
